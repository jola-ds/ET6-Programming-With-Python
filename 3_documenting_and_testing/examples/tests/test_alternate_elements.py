...
<<<<<<< HEAD:4_debugging/exercises/1_buggy_tests/tests/test_alternate_elements.py
        """It should return every other string from a list"""
=======
        """It should work with strings"""
>>>>>>> origin/main:3_documenting_and_testing/examples/tests/test_alternate_elements.py
